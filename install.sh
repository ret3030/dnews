...
cp dnews.sh reader.sh header.sh mark_read.sh strip_links.lua colorize.py categories.sh list_query.sh "$CONF/"
chmod +x "$CONF"/*.sh
...
for dep in fzf newsboat sqlite3 rdrview pandoc python3 less; do
